...
export default function App() {
  ...
  const projects = [
    { id: "Pipeline Bitcoin Agente IA", tittle: "Pipeline Bitcoin Agente IA", description: "Sistema de ETL com Python para monitoramento do preço do Bitcoin. Integra agentes de IA e dashboard interativo para consulta e visualização em tempo real.", image: "images/pipeline_bitcoin.png", repoLink: "https://github.com/vmellozk/pipeline-bitcoin-agno", viewProject: "https://pipeline-bitcoin.streamlit.app" },
    { id:"Niteroi Vazamentos", title: "Niterói Vazamentos", description: "Sistema de denúncias de vazamentos de água criado com o objetivo de beneficiar a comunidade local, com mapa e estatísticas.", image: "images/niteroi_vazamentos.png", repoLink: "https://github.com/vmellozk/sistema-vazamento-niteroi", viewProject: "https://sistema-vazamento-niteroi.vercel.app" },
