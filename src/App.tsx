...
export default function App() {
  ...
  const projects = [
    ...
    { id: "ChatBot WhatsApp com IA", title: "ChatBot WhatsApp com IA", description: "Automação de atendimento via WhatsApp com IA, integrando n8n, Google Sheets e Google Calendar.", image: "images/chatbot-n8n.jpg", repoLink: "", viewProject: "" },
